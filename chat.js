...
function getBotResponse(userInput) {
    ...
    if (userInput.includes('hello') || userInput.includes('hi')) {
        ...
        return `
            ...
            1. Travel Website: The Website is created to help families by creating an itinerary for their dream vacation and ensure each activity is suited for them. <a href="Travel2/index.html">View Project</a>
            ...
            3. Real-Estate Website: The Website is to help individuals as well as businesses to find, build, and renovate their dream home. <a href="Projects/onyx xampp/onyx/index.html">View Project</a>
        `;
    } else {
